    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="w-full overflow-x-auto">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full max-w-[600px] overflow-x-auto flex-nowrap">
            <TabsTrigger value="overview" className="flex-shrink-0">Overview</TabsTrigger>
            <TabsTrigger value="shipments" className="flex-shrink-0">Shipments</TabsTrigger>
            <TabsTrigger value="finance" className="flex-shrink-0">Financial</TabsTrigger>
            <TabsTrigger value="advanced" className="flex-shrink-0">Advanced Analytics</TabsTrigger>
          </TabsList>
